...
const VERIFIER_WORDS: Readonly<Record<string, string>> = {
  ...
  lookup_tables: "Your wallet added address lookup tables, which SaverFi does not relay. Nothing was sent.",
  ...
  old_program: "The transaction names a program SaverFi never talks to. Nothing was sent.",
  program_not_allowed: "Your wallet added an instruction for a program SaverFi does not relay. Nothing was sent.",
  instruction_count: "The transaction does not hold exactly the instructions this action needs. Nothing was sent.",
  unknown_discriminator: "The transaction's SaverFi instruction is not one the program has. Nothing was sent.",
  instruction_not_allowed: "The transaction is not an action your pension key signs. Nothing was sent.",
  compute_budget_invalid: "Your wallet set a fee or compute limit SaverFi does not relay. Nothing was sent.",
  ...
  lighthouse_misplaced: "Your wallet put a Lighthouse safety check between SaverFi's own instructions, which SaverFi does not relay. Nothing was sent.",
