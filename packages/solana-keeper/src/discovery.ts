...
//
// Ported from Nuvem's solana-lab keeper (keeper/src/discovery.ts), unchanged in
// substance: TradingLink kept its 129-byte layout in sip-vault.
//
...
// truncated by a node whose head lags.
//
